      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <SidebarLinkGroup activecondition={pathname === "/employees/dashboard" || pathname.includes("EmployeesDashboard")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname === "/employees/dashboard" || pathname.includes("EmployeesDashboard") ? "" : "hover:text-gray-900 dark:hover:text-white"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
              ...
              <SidebarLinkGroup activecondition={pathname === "/employees/dashboard/about" || pathname.includes("EmployeesAbout")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              <SidebarLinkGroup activecondition={pathname === "/employees/dashboard/course" || pathname.includes("EmployeesCourse")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              <SidebarLinkGroup activecondition={pathname === "/employees/dashboard/job" || pathname.includes("EmployeseJobPage")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
