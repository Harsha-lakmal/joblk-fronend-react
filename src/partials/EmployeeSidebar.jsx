      ...
      >
        ...
        <div className="space-y-8">
          <div>
            ...
            <SidebarLinkGroup activecondition={pathname === "/employee/dashboard" || pathname.includes("EmployeeDashboard")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname === "/employee/dashboard" || pathname.includes("EmployeeDashboard") ? "" : "hover:text-gray-900 dark:hover:text-white"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
              ...
              <SidebarLinkGroup activecondition={pathname === "/employee/dashboard/about" || pathname.includes("EmployeeAbout")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              <SidebarLinkGroup activecondition={pathname === "/employee/dashboard/course" || pathname.includes("EmployeeCourse")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              <SidebarLinkGroup activecondition={pathname === "/employee/dashboard/job" || pathname.includes("EmployeeJobPage")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
