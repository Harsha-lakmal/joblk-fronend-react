...
export default function AcceptCourseDocumentDetails () {
    ...
    function getData() {
        setLoading(true);
        instance.get('/course/getAcceptCourseDocument', {
            headers: {
    ...
    function deleteJobDocument(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                instance.delete(`/course/deleteAcceptCourseDocument/${id}`, {
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead className="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th className="py-3 px-6 text-left font-semibold">Course Title</th>
