      ...
      <div className="p-4">
        ...
        <div className="mb-4">
          <img 
            src={joblkimg} 
            alt="Course Image"
              // className="w-full h-auto rounded-xl shadow-md" // Styling the image
              width={'200px'}
              height={'200px'}
        ...
        <ul className="space-y-4">
          ...
          <li className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <span className="font-medium text-gray-800 dark:text-gray-100">Job Description:</span>
          ...
          <li className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <span className="font-medium text-gray-800 dark:text-gray-100">Job Qualifications:</span>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <li className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <span className="font-medium text-gray-800 dark:text-gray-100">Job Closing Date:</span>
          ...
          <li className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <span className="font-medium text-gray-800 dark:text-gray-100">Job Location:</span>
